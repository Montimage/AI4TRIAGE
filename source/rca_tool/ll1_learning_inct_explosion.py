...
row += '}, "timestamp": "' + str(now) + '", "description": "Potential explosion. Probable root-cause: Bomb. Action: Evacuate the crowd | Source/ Dataset: '+ db_source +' | Confidence (number of relevant reports): ' + str(len(NB_CONN)+len(MS_DELAY)) +'"}'
indicators += '}'
print row 
print indicators
known_state = db_dest["data_knowledge_inc"]
