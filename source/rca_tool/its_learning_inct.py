...
row += '}, "timestamp": "' + str(now) + '", "description": "Incident learned: Central gateway publishing messages significantly less than usual. Probable root-cause: failure in reporting data to the public gateway. Action: Check the connection/ reporting permission to the Public gateway | Source/ Dataset: '+ db_source +' | Confidence (number of relevant reports): ' + str(len(NB_CONN)+len(MS_DELAY)) +'"}'
indicators += '}'
print row 
print indicators
